...
# Own modules
from RSAI_Engine.Simulation.Environment.POIs.Core.Converter import Converter
from RSAI_Engine.Simulation.Environment.POIs.Prints.Shop_prints import Shop_prints

from RSAI_Engine.Simulation.States.Tools.Interests_tools import Interests_tools
from RSAI_Engine.Simulation.States.Inventory import Inventory

# from Ingenium_Engine.States.Transaction_gen import gen_transaction
...
class Shop(Converter):
    def __init__(self,
                 ...
                 traded_item_types: list = ["Resource"],
                 inventory: dict = None,
                 interests: dict = None,
        ...
        self.gen_dicts(traded_item_types=traded_item_types,
                       inventory=inventory,
                       interests=interests,
                    ...
                    if self.inventory[item_type][item] >= item_quantity:
                        ...
                        if agent.interests[item_type][item]["Expectation"] >= self.interests[item_type][item]["Expectation"]:
                            ...
                            self.interests[item_type][item] = \
                                interests_tools.increase_expectation(expectation_dict=self.interests[item_type][item],
                            ...
                            agent.interests[item_type][item] = \
                                interests_tools.decrease_expectation(expectation_dict=agent.interests[item_type][item],
                            ...
                            self.interests[item_type][item] = \
                                interests_tools.decrease_expectation(expectation_dict=self.interests[item_type][item],
                            ...
                            agent.interests[item_type][item] = \
                                interests_tools.increase_expectation(expectation_dict=agent.interests[item_type][item],
