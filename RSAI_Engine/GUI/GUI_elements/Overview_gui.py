...
class Overview_GUI:
    ...
    def update_agent_overview_tab(gui):
        # --> Set states
        gui.main_window.state_stab_attack.setText(str(gui.simulation.agent_lst[0].states()["Stab_attack"]))
        gui.main_window.state_slash_attack.setText(str(gui.simulation.agent_lst[0].states()["Slash_attack"]))
        gui.main_window.state_crush_attack.setText(str(gui.simulation.agent_lst[0].states()["Crush_attack"]))
        gui.main_window.state_magic_attack.setText(str(gui.simulation.agent_lst[0].states()["Magic_attack"]))
        gui.main_window.state_ranged_attack.setText(str(gui.simulation.agent_lst[0].states()["Ranged_attack"]))

        gui.main_window.state_stab_defence.setText(str(gui.simulation.agent_lst[0].states()["Stab_defence"]))
        gui.main_window.state_slash_defence.setText(str(gui.simulation.agent_lst[0].states()["Slash_defence"]))
        gui.main_window.state_crush_defence.setText(str(gui.simulation.agent_lst[0].states()["Crush_defence"]))
        gui.main_window.state_magic_defence.setText(str(gui.simulation.agent_lst[0].states()["Magic_defence"]))
        gui.main_window.state_ranged_defence.setText(str(gui.simulation.agent_lst[0].states()["Ranged_defence"]))

        gui.main_window.state_strength.setText(str(gui.simulation.agent_lst[0].states()["Strength"]))
        gui.main_window.state_ranged_strength.setText(str(gui.simulation.agent_lst[0].states()["Ranged_strength"]))
        gui.main_window.state_magic_damage.setText(str(gui.simulation.agent_lst[0].states()["Magic_damage"]))
        gui.main_window.state_prayer.setText(str(gui.simulation.agent_lst[0].states()["Prayer"]))
